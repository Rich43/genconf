...
def NamedTupleFactory(attribute_map, composite_relid = None):
	...
	To install::
		...
		>>> from genconf.library.drivers.postgresql.types.namedtuple import NamedTupleFactory
		>>> import postgresql
		>>> db = postgresql.open(...)
...
def namedtuples(stmt, from_iter = chain.from_iterable, map = starmap):
	...
	Use::
		...
		>>> from genconf.library.drivers.postgresql.types.namedtuple import namedtuples
